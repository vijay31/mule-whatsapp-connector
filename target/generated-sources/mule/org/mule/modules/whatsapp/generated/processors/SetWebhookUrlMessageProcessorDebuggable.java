...
public class SetWebhookUrlMessageProcessorDebuggable
    extends SetWebhookUrlMessageProcessor
    implements DebugInfoProvider
{


    public SetWebhookUrlMessageProcessorDebuggable(String operationName) {
        super(operationName);
    }
    ...
    public List<FieldDebugInfo<?>> getDebugInfo(MuleEvent muleEvent) {
        ...
        fieldDebugInfoList.add(createDevKitFieldDebugInfo("webhookUrl", "Webhook url", (java.lang.String.class), webhookUrl, muleEvent));
