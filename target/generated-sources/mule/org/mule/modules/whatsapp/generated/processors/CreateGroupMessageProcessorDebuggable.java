...
public class CreateGroupMessageProcessorDebuggable
    extends CreateGroupMessageProcessor
    implements DebugInfoProvider
{


    public CreateGroupMessageProcessorDebuggable(String operationName) {
        super(operationName);
    }
    ...
    public List<FieldDebugInfo<?>> getDebugInfo(MuleEvent muleEvent) {
        ...
        fieldDebugInfoList.add(createDevKitFieldDebugInfo("groupName", "Group name", (java.lang.String.class), groupName, muleEvent));
        fieldDebugInfoList.add(createDevKitFieldDebugInfo("phones", "Phones", (java.util.List.class), phones, muleEvent));
        fieldDebugInfoList.add(createDevKitFieldDebugInfo("message", "Message", (java.lang.String.class), message, muleEvent));
