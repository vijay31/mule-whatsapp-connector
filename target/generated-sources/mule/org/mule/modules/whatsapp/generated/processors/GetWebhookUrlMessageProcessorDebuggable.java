...
public class GetWebhookUrlMessageProcessorDebuggable
    extends GetWebhookUrlMessageProcessor
    implements DebugInfoProvider
{


    public GetWebhookUrlMessageProcessorDebuggable(String operationName) {
        super(operationName);
    }
