...
public class SendMessageMessageProcessorDebuggable
    extends SendMessageMessageProcessor
    implements DebugInfoProvider
{


    public SendMessageMessageProcessorDebuggable(String operationName) {
        super(operationName);
    }
    ...
    public List<FieldDebugInfo<?>> getDebugInfo(MuleEvent muleEvent) {
        ...
        fieldDebugInfoList.add(createDevKitFieldDebugInfo("number", "Number", (java.lang.String.class), number, muleEvent));
