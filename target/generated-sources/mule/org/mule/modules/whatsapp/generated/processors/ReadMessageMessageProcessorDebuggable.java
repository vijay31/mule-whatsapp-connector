...
public class ReadMessageMessageProcessorDebuggable
    extends ReadMessageMessageProcessor
    implements DebugInfoProvider
{


    public ReadMessageMessageProcessorDebuggable(String operationName) {
        super(operationName);
    }
    ...
    public List<FieldDebugInfo<?>> getDebugInfo(MuleEvent muleEvent) {
        ...
        fieldDebugInfoList.add(createDevKitFieldDebugInfo("last", "Last", (boolean.class), last, muleEvent));
        fieldDebugInfoList.add(createDevKitFieldDebugInfo("lastMessageNumber", "Last message number", (java.lang.Integer.class), lastMessageNumber, muleEvent));
