...
/**
 * A <code>WhatsappConnectorLifecycleInjectionAdapter</code> is a wrapper around {@link WhatsappConnector } that adds lifecycle methods to the pojo. This adapter also allows the injection of several Mule facilities when a MuleContext is set.
 * 
 */
@SuppressWarnings("all")
@Generated(value = "Mule DevKit Version 3.9.0", date = "2018-08-02T05:23:51+05:30", comments = "Build UNNAMED.2793.f49b6c7")
public class WhatsappConnectorLifecycleInjectionAdapter
    extends WhatsappConnectorMetadataAdapter
    implements MuleContextAware, Disposable, Initialisable, Startable, Stoppable
{
    ...
    {
        Logger log = LoggerFactory.getLogger(WhatsappConnectorLifecycleInjectionAdapter.class);
